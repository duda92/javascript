...
function aply_ui() {
    ...
    $('#order').dialog({ autoOpen: false, width: 700, height: 500, modal: true  });
}
...
function show_operations_form(person) {
    ...
    $('#operations_div').css('display', 'table-cell');
    show_history();
    show_history();
}
...
function hide_operations_form() {
    clear_form();
    clear_history();
    $('#operations_div').css('display', 'none');
}
